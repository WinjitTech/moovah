...
imgpath = GetCMSData.GetData('TermsAndConditions')

insertOrUpdateRecord(imgpath,"TermsAndConditions")

MoovahLogger.logger.info("TermsAndConditions updated successfully")