        ...
        try:
            for key in jsondata[i].keys():
                ...
                if 'SurveyMapping' in key:
                    insertOrUpdateRecord(value,'SurveyBoxMapping')
                else:
                    if 'SurveyQuestions' in key and not 'SurveyQuestionsOptions' in key:
                        insertOrUpdateRecord(value,"SurveyQuestions")
                    else:
                        if 'SurveyQuestionsOptions' in key:
                            insertOrUpdateRecord(value,"SurveyQuestionOptions")
                        else:
...
insertOrUpdateRecord(imgpath,"Survey")
