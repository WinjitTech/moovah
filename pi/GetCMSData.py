...
def GetDataFromCMS():
    ...
    # c.execute('select ModifiedDate from '+tblName+' order by ModifiedDate desc LIMIT 1')
    # for record in c.fetchall():
    ...
    # dataURL = str(dataURL).replace("khooloo.cloudapp.net","168.63.241.212")
    #
    #
    #
    # j = urllib2.urlopen(dataURL)
    # js = j.read()
    #
